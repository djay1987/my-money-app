  ...
  renderRows() {
    ...
    return list.map((item, index) => (
      <tr key={index}>
        ...
        <td>
          <IconButton type='success' icon='plus' onClick={() => this.add(index + 1)} />
          <IconButton type='warning' icon='clone' onClick={() => this.add(index + 1, item)} />
          <IconButton type='danger' icon='trash-o' onClick={() => this.remove(index)} />
        </td>
      </tr>
    ))
  }
